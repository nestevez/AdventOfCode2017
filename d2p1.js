...
var cells = [[493,458,321,120,49,432,433,92,54,452,41,461,388,409,263,58],
...
{
    let dmax = Number(cells[i][0]);
    let dmin = Number(cells[i][0]);
    for(let k = 1; k<cells[i].length; k++)
    {
        cells[i][k] = Number(cells[i][k]);
        if(cells[i][k]>dmax){
            dmax = cells[i][k];
        }
        else if (cells[i][k] < dmin)
        {
            dmin = cells[i][k];
        }
    }
