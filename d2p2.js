// finds the two numbers in each row which are evenly divisible 
// return the sum of the result of the divisions
...
// finds the two divisible values and passes the result to the array of numbers to sum
for(let i = 0; i < cells.length; i++)
{
    ...
    { 
        for(let a = 0; a<cells[i].length; a++){
            if(a!=k)
            {
                if(cells[i][a]%cells[i][k]==0)
                {
                    var diff = cells[i][a]/cells[i][k];
                    found = true;
                    break;
                }
                else if (cells[i][k]%cells[i][a]==0)
                {
                    var diff = cells[i][k]/cells[i][a];
                    found = true;
                    break;
                }
            }
